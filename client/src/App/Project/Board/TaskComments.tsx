...
const TaskComments = ({ taskId, initialComments = [], hideList = false, hideInput = false }: TaskCommentsProps) => {
    ...
    }, [taskId, initialComments, hideList]);
    ...
    const handleAddComment = async () => {
        ...
        try {
            ...
            const addedComment = response as any; 
            setComments(prev => [addedComment, ...prev]); 
            setNewComment('');
            // If list is hidden (e.g. in All tab), we might want to trigger a refresh in parent
            // But for now, local state update is fine if we are in Comments tab.
        } catch (error) {
